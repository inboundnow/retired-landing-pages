...
class lp_conversion_area_widget extends WP_Widget 
{
	...
	function lp_conversion_area_widget() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'class_lp_conversion_area_widget', 'description' => __('Use this widget on your landing page sidebar. This sidebar replaces the normal sidebar while using your default theme as a template, or other inactive themes as landing page templates.', INBOUNDNOW_LABEL) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'id_lp_conversion_area_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'id_lp_conversion_area_widget', __('Landing Pages: Conversion Area Widget', INBOUNDNOW_LABEL), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<?php _e("This box will render the landing page conversion area on the 'default' template." , INBOUNDNOW_LABEL ); ?>
		</p>
