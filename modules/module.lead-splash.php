...
<h3 class='lp-lead-splash-h3'><?php _e('Lead Details ' , INBOUNDNOW_LABEL ) ?>: </h3>
<?php // Conditional check for wp leads add on ?>
<a href="/wp-admin/post.php?post=<?php echo $lead_id . "&action=edit";?>" class="wplp-green-button wplp-right" target="_blank"> <?php _e( 'View/Edit Lead' , INBOUNDNOW_LABEL ); ?> </a>
</div>
<div id="wp-leads-splash-name">
<div class="wp-lead-label"><?php _e('Name' , INBOUNDNOW_LABEL ); ?>:</div> <?php echo $wplead_data['wpleads_first_name'][0]; ?> <?php echo $wplead_data['wpleads_last_name'][0]; ?> 
</div>
			
<div id="wp-leads-splash-email">
<div class="wp-lead-label"><?php _e('Email Address' , INBOUNDNOW_LABEL ); ?>:</div> <?php echo $wplead_data['wpleads_email_address'][0]; ?>
</div>
<div id="wp-leads-splash-ip">
<div class="wp-lead-label"><?php _e('IP Address' , INBOUNDNOW_LABEL ); ?>: </div> <?php echo $wplead_data['wpleads_ip_address'][0]; ?>
</div>
<div id="wp-leads-splash-city">
<div class="wp-lead-label"><?php _e('City' , INBOUNDNOW_LABEL ); ?>: </div> <?php echo $city; ?>
</div>
<div id="wp-leads-splash-state">
<div class="wp-lead-label"><?php _e('State' , INBOUNDNOW_LABEL ); ?>: </div> <?php echo $region; ?>
</div>
