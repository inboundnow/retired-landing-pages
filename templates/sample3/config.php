 ...
 * Template Name:    Qobo Sample 3 Template - Landing Pages
...
$lp_data[$key]['info'] =
    array(
        ...
        'label' => "Qobo Sample 3", // Nice Name
        'category' => 'Qobo Sample 3', // Template Category
        'demo' => '', // Demo Link
        'description' => 'Sample Template Number 3' // template description
    );
...
$lp_data[$key]['settings'] =
    array(
        ...
        array(
            'label' => __('Top Content', 'landing-pages'),
        ...
        array(
            ...
            'id' => 'top-color', // called in template's index.php file with lp_get_value($post, $key, 'color-picker-id');
            'type' => 'colorpicker',
            'default' => 'ffffff',
            'context' => 'normal'
        ),
