...
/* $wp_cta_data[$key]['options'] Parameters
...
//notes: 'value', and 'thumbnail' can be autogenerated in the array loop with the $key param we dont need to specify them here
          The thumbnail can be auto pulled in loop though the parent $key value. we probably dont need this. default='blank placeholder image if image not set in template folder'
*/
...
array(
    array(
        ...
        'id' => 'instructions', // metakey. $key Prefix is appended from parent in array loop
