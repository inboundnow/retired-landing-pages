...
//$media_id = lp_get_value($post, $key, 'show-logo');
...
<div id="wrapper">
    ...
    <div id="top-content" class="container-fluid" style="background: #fff url('http://www.easy-forex.com/EVO/images/LP_template_top_grey_gradient_2.jpg') bottom repeat-x;">

        <div id=""  class="container" style="background-color: <?php  echo '#'.$top_color?>">
    ...
    <div class="container">
        ...
        <div id="content-wrapper">
            <div id="content" style="background-color: <?php  echo '#'.$main_color?>">
    ...
    <div class="container-fluid " style="background-color: #666666;height: 50px">
    ...
    <footer>
        <div class="container">
            ...
            <div class="row" style="background-color: <?php  echo '#'.$footer_color?>">
