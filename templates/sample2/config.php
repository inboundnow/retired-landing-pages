 ...
 * Template Name:    Qobo Sample 2 Template - Landing Pages
...
$lp_data[$key]['info'] =
    array(
        ...
        'label' => "Qobo Sample 2", // Nice Name
        'category' => 'Qobo Sample 2', // Template Category
        'demo' => '', // Demo Link
...
$lp_data[$key]['settings'] =
    array(
        ...
        array(
            ...
            'description' => __('Top Content', 'landing-pages'),
            'id' => "top-content",
            'type' => "wysiwyg",
            'default' => ''
        ),
